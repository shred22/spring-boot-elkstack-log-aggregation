...
```json
{
   ...
   "logger_name": "com.boot.elk.logaggregation.post.service.PostService",
...
Before starting, ensure you at least Java 11, Maven 3.x and Docker set up. Then clone the repo from GitHub:
